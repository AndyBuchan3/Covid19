...
labs <- data.frame(Type = c("Cases", "Deaths"), labx = c(as.Date("20-03-20", format = "%d-%m-%y"), as.Date("01-04-20", format = "%d-%m-%y")), laby = c(10^4, 6000))
lab2 <- data.frame(Type1 = c(UK_total_cases, UK_total_deaths), labx = c(as.Date("20-03-20", format = "%d-%m-%y"), as.Date("01-04-20", format = "%d-%m-%y")), laby = c(10^4+3000, 9000))
